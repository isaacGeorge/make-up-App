...
export const GETTING_STARTED_STEPS = [
  ...
  },
  {
    ...
    hint: 'Create a new directory called <code>me</code> in <code>src/routes</code>. Within this directory create a <code>card.tsx</code> file or copy the <code>src/routes/card.tsx</code> file. Your new route is now accessible <a href="/me" target="_blank">here</a> ✨',
  },
  {
